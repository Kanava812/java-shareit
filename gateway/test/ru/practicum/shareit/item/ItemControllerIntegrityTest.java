...
class ItemControllerIntegrityTest {
    ...
    @SneakyThrows
    @Test
    void addItemInvalidFieldsTest() {
        // Пустое имя
        CreateItemDto emptyName = new CreateItemDto("", "Description", true, null);

        // Пустое описание
        CreateItemDto emptyDescription = new CreateItemDto("Name", "", true, null);

        // Отсутствует available
        CreateItemDto nullAvailable = new CreateItemDto("Name", "Description", null, null);
    ...
    @SneakyThrows
    @Test
    void updateItemInvalidItemIdTest() {
